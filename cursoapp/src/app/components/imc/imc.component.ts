...
Cálculo: 68 ÷ 1,652 (2,7225) = 24,98*/
  ...
  ordenarPorPeso() {
    ...
    this.array_imcs.sort(function (a, b) {
      let resultado = 0;
     
        //resultado = a.peso - b.peso;//ordena de menor a mayor peso
        resultado = b.peso - a.peso;//ordena de mayor a menor peso
  ...
  ordenarPorAltura() {
    ...
    this.array_imcs.sort( (a: Imc, b: Imc) => {
       return (a.altura - b.altura);//ordena de mayor a menor peso
    });
  }
  ...
  obtenerMediaPeso(array_caluclo: Array<Imc>): number {
    ...
    array_caluclo.forEach((imc_temporal) => {
  ...
  obtenerMediaAltura(array_caluclo: Array<Imc>): number {
    ...
    array_caluclo.forEach((imc_tem) => {
      sumatorio = sumatorio + imc_tem.altura;
    });
